...
using Contact_zoo_at_home.Server.Admin.Configuration.Database;
...
using Contact_zoo_at_home.Server.Admin.Helpers;
...
using Contact_zoo_at_home.Server.Shared.Dtos.Identity;

namespace Contact_zoo_at_home.Server.Admin
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            AdminLogDbContext, AdminAuditLogDbContext, AuditLog, IdentityServerDataProtectionDbContext,
                ...
                UserIdentityUserLogin, UserIdentityRoleClaim, UserIdentityUserToken, int,
