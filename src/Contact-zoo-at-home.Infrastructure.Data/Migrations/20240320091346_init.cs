    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationOptions", x => x.TargetId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_NotificationOptions_Id",
                        column: x => x.Id,
                        principalTable: "NotificationOptions",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contracts_CompanyRepresentatives_RepresentativeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PetsInContractJoin_Contracts_BaseContractId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolyContractId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StandartContracts_Contracts_PartOfOtherContractId",
                        column: x => x.PartOfOtherContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StandartContracts_PolyContracts_PolyContractId",
                        column: x => x.PolyContractId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StandartContracts_PolyContractId",
                table: "StandartContracts",
                column: "PolyContractId");
